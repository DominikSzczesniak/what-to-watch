...
@Component
public class DeleteMovieToWatchCoverRestInvoker extends BaseRestInvoker {

	private static final String URL = "/api/movies/{movieId}/cover";

	DeleteMovieToWatchCoverRestInvoker(final TestRestTemplate restTemplate) {
		super(restTemplate);
	}

	public ResponseEntity<Void> deleteMovieToWatchCover(final LoggedUser loggedUser, final Integer movieId) {
